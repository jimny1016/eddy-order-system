    ...
    export default {
        ...
        watch: {
            tempComboDishDetailKey: {
                ...
                handler(newVal) {
                    if (newVal) {
                        this.dish = JSON.parse(JSON.stringify(this.beUpdatedCartCell.cartCell.product.options[this.tempComboDishDetailKey.optionIndex].optionVaules[this.tempComboDishDetailKey.optionValueIndex]));
        ...
        methods:{
            ...
            addToCombo() {
                ...
                let beUpdateCartCell = JSON.parse(JSON.stringify(this.beUpdatedCartCell));
                let tempComboResult = beUpdateCartCell.cartCell.product;
                ...
                this.$store.dispatch('updateBeUpdatedCartCell', { cartCell:beUpdateCartCell });
